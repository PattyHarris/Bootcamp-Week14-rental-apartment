...
// Returns true if the given date is booked.
...
// Returns true if the day is selectable.
export const isDaySelectable = (day, bookedDates) => {
  // If the day is being unselected...
  if (!day) {
    return true;
  }
...
// Used to figure out the date range?
...
// Returns the dates between a start and end date.  Used to help verify
// that the dates between 2 given dates are selectable.
export const getDatesBetweenDates = (startDate, endDate) => {
  let dates = [];

  // To avoid modifying the original date, the 'startDate' is cloned.
...
// Returns the list of dates that are blocked.
